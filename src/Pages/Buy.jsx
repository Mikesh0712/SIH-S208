  ...
  <div style={{
    ...
    <div className="container d-flex align-items-center flex-nowrap">
      ...
      <marquee behavior="scroll" direction="left" scrollamount="5" style={{ width: '100%' }}>
        Fresh arrivals daily • Special discounts on seeds and fertilizers • Sell your produce directly to buyers • Secure payments and trusted sellers • Stay tuned for more updates!
      </marquee>
    </div>
  </div>
