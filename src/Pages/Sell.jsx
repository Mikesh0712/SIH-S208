  ...
  <div style={{
    ...
    <div className="container d-flex align-items-center flex-nowrap">
      ...
      <marquee behavior="scroll" direction="left" scrollamount="5" style={{ width: '100%' }}>
        List your produce and reach more buyers • Fast payouts for verified sellers • New: Highlight your best products • Need help? Contact our support team • Stay tuned for more updates!
      </marquee>
    </div>
  </div>
